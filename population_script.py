...
def populate():
    ...
    users = [{"username": "desuderata",
             ...
             {"username": "susamusa29",
              ...
              "profilePicture": "profile_images/susamusa.png",
              "courseMain": "Computing Science",
              "year": "2"},
             {"username": "abrar928",
              ...
              "profilePicture": "profile_images/abrar.png",
              "courseMain": "Computing Science",
              "year": "2"},
...
def add_book(image, title, author, course, year, descr, isbn, price):
    b = Book.objects.get_or_create(bookName=title)[0]
    b.bookImage = image
    b.bookAuthor = author
    b.course = course
    b.year = year
...
def add_listing(username, books, description):
